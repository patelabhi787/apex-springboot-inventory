...
public class ProductService {
    ...
    public Collection<Product> getAllProduct() {
    	List<RecalledProduct> allRecalled = recalledProductRepository.findAll();
    	Set<String> recalledNames = allRecalled.stream().map(RecalledProduct::getName).collect(Collectors.toSet());
